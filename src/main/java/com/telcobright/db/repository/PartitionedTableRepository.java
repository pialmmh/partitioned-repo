...
/**
 * Single partitioned table repository for Order entities
 * Uses MySQL native partitioning on single table 'orders'
 * Partitions by date: p20250803, p20250804, etc.
 */
public class PartitionedTableRepository {
    ...
    private PartitionedTableRepository(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder partitionRetentionPeriod(int days) {
            this.partitionRetentionPeriod = days;
            return this;
        }
        
        public Builder autoManagePartitions(boolean autoManage) {
            this.autoManagePartitions = autoManage;
            return this;
        }
        
        public Builder initializePartitionsOnStart(boolean initialize) {
            this.initializePartitionsOnStart = initialize;
            return this;
        }
        
        public PartitionedTableRepository build() {
            ...
            return new PartitionedTableRepository(this);
        }
    }
