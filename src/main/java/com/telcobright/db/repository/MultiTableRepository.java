...
/**
 * Multi-table repository for SMS entities
...
public class MultiTableRepository {
    ...
    private MultiTableRepository(Builder builder) {
    ...
    public static class Builder {
        ...
        public MultiTableRepository build() {
            ...
            return new MultiTableRepository(this);
        }
    }
