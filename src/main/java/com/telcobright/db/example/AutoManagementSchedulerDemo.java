...
public class AutoManagementSchedulerDemo {
    ...
    private static void demonstrateSchedulers() throws SQLException, InterruptedException {
        ...
        System.out.println("🗂️ Creating MultiTableRepository with scheduled maintenance...");
        ...
        System.out.println("🏗️ Creating PartitionedTableRepository with scheduled maintenance...");
