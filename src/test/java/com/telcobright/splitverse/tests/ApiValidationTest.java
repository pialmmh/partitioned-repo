 ...
 *
 * DESCRIPTION:
 * This test suite validates the API contract of SplitVerseRepository without
 * requiring database connectivity. It ensures that the builder properly validates
 * all configuration parameters and provides clear error messages for invalid
 * configurations. These tests run quickly and don't require MySQL setup.
 *
 * TESTS:
