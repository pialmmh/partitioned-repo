...
public class ShardingStrategyTest {
    ...
    public static class TestOrder implements ShardingEntity<LocalDateTime> {
    ...
    public void testSingleKeyHashStrategy() {
        ...
        ShardingRepository<TestOrder, LocalDateTime> repository = SplitVerseRepository.<TestOrder, LocalDateTime>builder()
