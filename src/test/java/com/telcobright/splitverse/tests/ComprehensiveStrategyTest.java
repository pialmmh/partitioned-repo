...
public class ComprehensiveStrategyTest {
    ...
    private static Map<String, ShardingRepository<TestEntity>> repositories = new HashMap<>();
    ...
    public static void cleanup() {
        ...
        for (ShardingRepository<TestEntity> repo : repositories.values()) {
            repo.shutdown();
        }
    ...
    public void testSingleKeyHashStrategy() throws SQLException {
        ...
        ShardingRepository<TestEntity> repo = createRepository(
            strategyName,
    ...
    private ShardingRepository<TestEntity> createRepository(
        String name,
        ...
        SplitVerseRepository.Builder<TestEntity> builder = SplitVerseRepository.<TestEntity>builder()
        ...
        ShardingRepository<TestEntity> repo = builder.build();
    ...
    private void performCrudOperations(ShardingRepository<TestEntity> repo,
                                       TestEntity entity,
