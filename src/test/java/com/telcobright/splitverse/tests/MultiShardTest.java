...
public class MultiShardTest {
    ...
    @Table(name = "orders")
    public static class OrderEntity implements ShardingEntity {
    ...
    private static ShardingRepository<OrderEntity> multiShardRepo;
    ...
    public static void setup() throws SQLException {
        ...
        multiShardRepo = SplitVerseRepository.<OrderEntity>builder()
