...
public class SqlPregenerationTest {
    ...
    private ShardingRepository<TestEvent> repository;

    @Table(name = "test_events")
    public static class TestEvent implements ShardingEntity {
    ...
    public void testSqlPregenerationWithValueRange() throws Exception {
        ...
        repository = SplitVerseRepository.<TestEvent>builder()
    ...
    public void testSharedSqlRegistryAcrossRepositories() throws Exception {
        ...
        ShardingRepository<TestEvent> repository1 = SplitVerseRepository.<TestEvent>builder()
            .withEntityClass(TestEvent.class)
