...
public class SequentialLogRepositoryTest {
    ...
    void testLogIngestionAndRetrieval() throws SQLException {
        ...
        assertEquals(logs.size(), totalRetrieved, "Should retrieve all logs sequentially");
        System.out.println("✓ Successfully retrieved all " + totalRetrieved + " logs using sequential pagination");
    }
    ...
    void testCursorBasedIteration() throws SQLException {
        ...
        assertEquals(totalLogs, totalProcessed, "Should process all logs exactly once");
        System.out.println("\n✓ Successfully iterated through all " + totalProcessed +
            " logs in " + iterations + " iterations");
    }
