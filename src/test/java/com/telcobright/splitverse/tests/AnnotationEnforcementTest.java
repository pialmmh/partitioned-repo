...
public class AnnotationEnforcementTest {
    ...
    static class MultipleIdEntity implements ShardingEntity {
        @Id(autoGenerated = false)
        private String id1;
    ...
    static class MultipleShardingKeyEntity implements ShardingEntity {
        @Id(autoGenerated = false)
        private String id;
    ...
    static class WrongIdTypeEntity implements ShardingEntity {
        @Id(autoGenerated = false)
    ...
    static class WrongShardingKeyTypeEntity implements ShardingEntity {
        @Id(autoGenerated = false)
        private String id;
    ...
    static class AutoGeneratedIdEntity implements ShardingEntity {
    ...
    static class NoIdEntity implements ShardingEntity {
    ...
    static class NoShardingKeyEntity implements ShardingEntity {
        @Id(autoGenerated = false)
        private String id;
